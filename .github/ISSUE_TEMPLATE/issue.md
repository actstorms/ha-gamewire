...
- Add version of the `gamewire` integration.
...
If you are unsure about the version check the [github release here](https://github.com/actstorms/ha-gamewire/releases).
...
logger:
  default: debug
  logs:
    custom_components.gamewire: debug
-->
